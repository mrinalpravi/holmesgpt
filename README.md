...
| [<img src="images/integration_logos/karpenter-icon.png" alt="Karpenter" width="20" style="vertical-align: middle;"> **Karpenter**](https://holmesgpt.dev/data-sources/builtin-toolsets/karpenter/) | NodePools, NodeClaims, EC2NodeClasses, disruption events and controller logs for node autoscaling investigations |
